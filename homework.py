...
'''
my_new_list = list(map(lambda x: x.lower(), my_list))
print(my_new_list)

'''
Задание 3.2 Получить из list пункта 3 dict, ключами которого являются слова, а значениями их количество появлений в тексте
'''
my_dict = {}
